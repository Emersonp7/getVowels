My idea was to be able to write one small program that can get all the vowels in a string and be able to recreate the same program in different languages.
